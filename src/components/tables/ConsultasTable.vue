<script setup>
    ...
    const openDetailsDialog = (consulta) => {
        ...
        <DataTable  
            ...
            <Column  style="width: 20%">
             <template #body="slotProps">
                  <Button icon="pi pi-trash" class="p-button-rounded p-button-danger" @click.stop="handleDelete(slotProps.data.id)"/>
             </template>
            </Column>
            <Column  style="width: 20%">
                <template #body="slotProps">
                   <Button icon="pi pi-pencil" class="p-button-rounded p-button-warning mr-2" @click.stop="openEditDialog(slotProps.data)" />
                </template>
            </Column>
        </DataTable>
...
.clickable .p-datatable-tbody > tr {
  cursor: pointer;
}
</style>